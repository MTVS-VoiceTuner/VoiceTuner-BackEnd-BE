...
import com.midnight.e5project.model.service.PPTService;
...
//        builder.part("audio_file", file.getResource());
        ...
        // 추가된 부분
        try {
            // WebClient를 사용하여 외부 서버에 POST 요청
            ...
            // 응답 오류 처리
//            log.error("Status code: {}, Response body: {}", e.getStatusCode(), e.getResponseBodyAsString());
...
//                .uri(REQUEST_URL + "/vocal/upload-audio") // 요청할 URI를 설정합니다.
